...
public class Ride_History extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  try {*/
            ...
            rating = (ButtonText) findViewById(R.id.rating);
            ...
            if (extras == null) {
                ...
                bookingId = extras.getString("bid");
                brating = extras.getString("brating");
            }

            if (!cd.isConnectingToInternet()) {
                alert.showAlertDialog(Ride_History.this,
            ...
            if(brating.equals("0")){
                ...
                public void onClick(View v) {
                    ...
                    Intent in = new Intent(Ride_History.this, RatingActivity.class);
                    in.putExtra("UserId", uid);
                    in.putExtra("booking_id", bookingId);
                    in.putExtra("uniqueId", bid);
                    in.putExtra("duration", bduration);
                    in.putExtra("date", bdate);
                    startActivity(in);
                    finish();
        ...
        else
        {
            ...
            rating.setEnabled(true);
            rating.setText("Rating done! Book a driver");
            rating.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent in = new Intent(Ride_History.this,MainActivity.class);
                    in.putExtra("UserId",uid);
                    startActivity(in);
                    finish();
                }
       ...
       /* }catch (Exception e){
            generateNoteOnSD("Ride_history_log"+date1+":"+hour+":"+minute+":"+seconds+":"+milliseconds, e.toString());
        }*/
    }
